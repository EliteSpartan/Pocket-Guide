...
public class MinecraftPCOld extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_minecraft_pc_old);
        ...
        CategoriesListAdapter listAdapter = new CategoriesListAdapter(MinecraftPCOld.this, mListTitles, mListDesc, mImageId);
